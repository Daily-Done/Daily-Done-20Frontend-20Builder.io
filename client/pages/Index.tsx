  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-600 to-sky-500 text-white py-20 overflow-hidden">
        <div className={"absolute inset-0 bg-[url('data:image/svg+xml,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\"><defs><pattern id=\"grain\" width=\"100\" height=\"100\" patternUnits=\"userSpaceOnUse\"><circle cx=\"50\" cy=\"50\" r=\"1\" fill=\"rgba(255,255,255,0.05)\"/></pattern></defs><rect width=\"100\" height=\"100\" fill=\"url(%23grain)\"/></svg>')] opacity-30"}></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl opacity-90 leading-relaxed">
                From grocery runs to pet care, connect with verified helpers in your neighborhood for any task, anytime.
              </p>
            ...
            <Card className="bg-white/95 backdrop-blur-sm shadow-2xl border-0">
              <CardHeader className="text-center border-t-4 border-blue-600 rounded-t-lg">
                <CardTitle className="text-2xl text-gray-900">Request a task</CardTitle>
              ...
              <CardContent className="space-y-6">
                <form onSubmit={handleTaskSubmit} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-lg py-6">
      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: '🛒', title: 'Grocery & Shopping', desc: 'Get fresh groceries, medicines, and daily essentials delivered by trusted neighbors from your favorite stores.' },
              { icon: '📦', title: 'Pickup & Delivery', desc: 'Package collection, document submission, courier services, and local deliveries handled with care.' },
              { icon: '🐕', title: 'Pet Care', desc: 'Dog walking, pet sitting, vet visits, and pet care services by verified animal lovers in your area.' },
              { icon: '🏠', title: 'Household Tasks', desc: 'Small repairs, cleaning assistance, furniture assembly, and home organization by skilled helpers.' },
              { icon: '👥', title: 'Personal Assistance', desc: 'Queue waiting, appointment bookings, bank visits, and other personal errands done efficiently.' },
              { icon: '🚗', title: 'Transportation', desc: 'Local rides, airport transfers, moving assistance, and transportation help when you need it most.' },
            ].map((service, index) => (
      ...
      <section id="how-it-works" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">How DailyDone works</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { step: '1', title: 'Tell us what you need', desc: 'Describe your task, set your budget, and choose when you need it done. Our smart system will match you with the right helpers.' },
              { step: '2', title: 'Get matched instantly', desc: 'Receive offers from verified helpers nearby within minutes. View their profiles, ratings, and choose who you prefer.' },
              { step: '3', title: 'Track and communicate', desc: 'Stay connected with your helper through our secure chat. Get real-time updates and photos of task progress.' },
              { step: '4', title: 'Pay and review', desc: 'Pay securely through the app when your task is complete. Rate your experience to help build our trusted community.' },
            ].map((step, index) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <div className="space-y-3">
                <a href="#" className="block text-gray-300 hover:text-white transition-colors">About DailyDone</a>
            ...
            <div>
              ...
              <div className="space-y-3">
                <a href="#" className="block text-gray-300 hover:text-white transition-colors">For customers</a>
                <Link to="/helper-signup" className="block text-gray-300 hover:text-white transition-colors">For helpers</Link>
