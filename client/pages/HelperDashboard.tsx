    ...
    const mockAvailableTasks: Task[] = [
      {
        ...
        description:
          "Need someone to buy vegetables and fruits from the nearby market. I'll provide the exact list and money.",
        category: "grocery",
        urgency: "today",
      ...
      },
      {
        ...
        description:
          "My elderly father needs his regular medicines. The prescription is ready at Apollo Pharmacy.",
        category: "delivery",
        urgency: "urgent",
      ...
      },
      {
        ...
        description:
          "My Golden Retriever needs a 30-minute walk in the evening. Very friendly and well-trained dog.",
        category: "pet-care",
        urgency: "flexible",
      ...
      },
      {
        ...
        description:
          "Need to send important documents to my office in BKC. Small envelope, very important.",
        category: "delivery",
        urgency: "urgent",
    ...
    const mockMyTasks: MyTask[] = [
      {
        ...
        description:
          "Weekly grocery shopping for Mrs. Sharma. She's provided a detailed list.",
        budget: 200,
        status: "accepted",
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl opacity-90">
                Browse available tasks in your area and start earning while
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            {filteredAvailableTasks.map((task) => (
              <Card
                key={task.id}
                className="hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-0 shadow-md relative"
              >
          ...
          {filteredAvailableTasks.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Check back soon for new opportunities to help neighbors!
              </p>
            </div>
          )}
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mb-6">
              Track your ongoing and completed tasks
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredMyTasks.map((task) => (
              <Card key={task.id} className="border-0 shadow-md relative">
                ...
                <CardContent className="p-6">
                  <h3 className="font-bold text-lg mb-3 leading-tight pr-20">
                    {task.title}
                  </h3>
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3">
                    {task.description}
                  ...
                  <div className="space-y-2 mb-4 text-xs text-gray-500">
                    ...
                    <div className="flex items-center gap-1">
                      <DollarSign className="w-3 h-3" />₹{task.budget}
                    </div>
                    <div className="flex items-center gap-1">
                      <Clock className="w-3 h-3" />
                      {task.acceptedTime}
