  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Thank you for signing up! We will review your application and get back to you soon.",
      });
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl opacity-90 leading-relaxed">
                Turn your free time into earnings by completing tasks for people
                in your neighborhood. Be your own boss, work when you want.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Enjoy freedom, flexibility, and the satisfaction of helping your
              community.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 to-sky-500 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl opacity-90 mb-8">
            Join thousands of helpers who are already earning while making their
            communities better.
          </p>
